<?php
    ...
    class DocenteDAO{
        ...
        public function buscarPorIdNombreConcatenado($docenteId){
            try{
                
                $conexion = Conexion::getConexion();
                $sql = "CALL sp_docente_buscar_por_id_nombre_concatenado(?)";
                $query = $conexion->prepare($sql);
        ...
        public function buscarPorDNINombreConcatenado($dniDocente){
            try{
                
                $conexion = Conexion::getConexion();
                $sql = "CALL sp_docente_buscar_por_dni_nombre_concatenado(?)";
                $query = $conexion->prepare($sql);
