    ...
    <body>
        <section id="iniciar-sesion">
            <div class="container">
                ...
                <input name="nombreCurso" type="text" value="<?php echo $curso->getNombre(); ?>">
                <br><br>
                <label for="">Número de horas:</label>
                <input name="nHoras" type="text" value="<?php echo $curso->getNHoras(); ?>">
                <br><br>
                ...
                <a href="gestionar_cursos.php"> Regresar </a>
            </form>
            </div>
        </section>
    </body>
