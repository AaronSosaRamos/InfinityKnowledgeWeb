    ...
    class DirectorAcademicoDAO{
        ...
        public function insertar(DirectorAcademico $directorAcademico){
            try {
                ...
                if(str_contains($e->getMessage(),'idx_director_academico_dni')){
                    throw new Exception("El dni del director académico ingresado ya existe en el sistema");
                }

                if(str_contains($e->getMessage(),'idx_director_academico_numero_telefonico')){
                    throw new Exception("El número director del auxiliar académico ingresado ya existe en el sistema");
                }
