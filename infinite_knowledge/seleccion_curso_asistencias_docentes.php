    ...
    <section>
        <div class="container">
            ...
            <table class="modeloTabla">
                ...
                ?>
                <tr>
                    <td> <a href="<?php echo "gestionar_asistencias_docente.php?id=".$curso->getCursoId(); ?>"> <?php echo $curso->getNombre(); ?> </a> </td>
                </tr>
                <?php } ?>
            </table>
            <br>
            <br><br>
            <button> <a href="insertar_registro_asistencia.php "> Insertar asistencia </a> </button>
